...
class Service(db.Model):
    ...
    description = db.Column(db.Text)
    price = db.Column(db.Float, nullable=False)
    duration = db.Column(db.String(50))  # e.g., "1 hour", "30 minutes"
    category = db.Column(db.String(50))
    image = db.Column(db.String(200))
    is_active = db.Column(db.Boolean, default=True)
    created_at = db.Column(db.DateTime, default=datetime.utcnow)
    ...
    order_items = db.relationship('ServiceOrderItem', backref='service', lazy='dynamic', cascade='all, delete-orphan')
...
class Order(db.Model):
    ...
    payment_method = db.Column(db.String(20), default='cod')  # cod, qr, stripe
