...
# Import app and db from app.py file by removing the app directory from path temporarily
original_path = sys.path[:]
if os.path.join(os.getcwd(), 'app') in sys.path:
    sys.path.remove(os.path.join(os.getcwd(), 'app'))
